<?php
//Save image via AJAX
add_action('wp_ajax_ansimuz_ajax_upload', 'ansimuz_ajax_image_upload'); //Add support for AJAX save

function ansimuz_ajax_image_upload(){
...
add_action('wp_ajax_ansimuz_ajax_remove', 'ansimuz_ajax_image_remove'); //Add support for AJAX save

function ansimuz_ajax_image_remove(){
	global $wpdb; //Now WP database can be accessed
